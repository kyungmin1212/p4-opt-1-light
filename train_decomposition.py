...
def train(
    ...
    model_instance.model.load_state_dict(torch.load('/home/kyungmin/pstage4/code/exp/2021-06-09_01-01-01/best.pt', map_location=device))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", default="configs/model/squeezenet.yaml", type=str, help="model config"
    )
    parser.add_argument(
