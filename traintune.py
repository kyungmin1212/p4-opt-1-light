...
def train(
    ...
    model_instance.model.load_state_dict(torch.load('/home/kyungmin/pstage4/code/exp/2021-06-11_13-41-17/best.pt', map_location=device))
    ...
    #     pct_start=0.05,
    # )
    # optimizer = optim.Adam(model_instance.model.parameters(), lr = 0.001)
    # scheduler = CosineAnnealingWarmUpRestarts(optimizer, T_0=10, T_mult=1, eta_max=0.1,  T_up=3, gamma=0.5)
    # # https://gaussian37.github.io/dl-pytorch-lr_scheduler/
    # scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=10, 
    #                                                         T_mult=1, eta_min=0.00001)
    optimizer = torch.optim.SGD(
        model_instance.model.parameters(), lr=0.000001, momentum=0.9
    )
    scheduler = CosineAnnealingWarmUpRestarts(optimizer, T_0=50, T_mult=1, eta_max=0.1,  T_up=5, gamma=0.5)
    # scheduler = torch.optim.lr_scheduler.OneCycleLR(
    #     optimizer=optimizer,
    #     max_lr=data_config["INIT_LR"],
    #     steps_per_epoch=len(train_dl),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", default="/home/kyungmin/pstage4/code/exp/2021-06-11_13-41-17/model.yml", type=str, help="model config"
    )
    parser.add_argument(
